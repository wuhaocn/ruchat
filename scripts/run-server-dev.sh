...
if [[ "${MODE}" == "split" ]]; then
  ...
  export RU_SERVER_PUBLIC_WS_BASE="${RU_SERVER_PUBLIC_WS_BASE:-ws://127.0.0.1:18081/ws/nodes}"
  ...
  export RU_SERVER_PUBLIC_WS_BASE="${RU_SERVER_PUBLIC_WS_BASE:-ws://127.0.0.1:18080/ws/nodes}"
